...
class LocaleService {
  static Future<Map<Locale, String>> getLocalesMap(List<String> locales,
  ...
  static Future<Map<String, dynamic>> getLocaleContent(Locale locale,
      Map<Locale, String> supportedLocales,
      String? remoteLocalizedContent) async {
    ...
    return json.decode(
        remoteLocalizedContent != null ? remoteLocalizedContent : content);
  }
}
