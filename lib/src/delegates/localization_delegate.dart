...
class LocalizationDelegate extends LocalizationsDelegate<Localization> {
  ...
  final String? remoteLocalizedContent;
  ...
  LocalizationDelegate._(this.fallbackLocale, this.supportedLocales,
      this.supportedLocalesMap, this.remoteLocalizedContent, this.preferences);
  ...
  Future changeLocale(Locale newLocale) async {
    ...
    var localizedContent = await LocaleService.getLocaleContent(
        locale, supportedLocalesMap, remoteLocalizedContent);
  ...
  static Future<LocalizationDelegate> create({required String fallbackLocale,
    ...
    LocalizationDelegate._(
        fallback, locales, localesMap, remoteLocalizedContent, preferences);
